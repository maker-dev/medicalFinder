export default function SubscribeBar(){
    ...
    return(
        <div>
            <div className="bg-secondary py-7 rounded-lg px-8 lg:px-0 mx-auto">
    <div className=" flex flex-wrap mx-auto items-center w-fit">
      <div className="max-w-lg lg-0">
        <p className="text-white">
          Catch the latest in pharmacy product updates, expert tips, and
          exclusive offers every week - subscribe now !
        </p>
      </div>
