...
export default function ErrorPage(){
    ...
    return(  
        <>
            <div className="flex flex-col items-center justify-center space-y-6 w-full h-screen bg-main-400"  style={{marginTop: -80}}>
                ...
                <button onClick={handleClick} type="button" className=" flex items-center justify-center w-1/2 px-5 py-2 text-sm transition-colors duration-200 bg-slate-900 text-white stroke-white hover:text-slate-900 hover:stroke-slate-900 hover:bg-white rounded-lg gap-x-2 sm:w-auto ">
